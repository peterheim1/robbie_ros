...
class Robbie_memory():
    ...
    def MeMemory_read(self):
        ...
        '''
        pkl_file = open('~/catkin_ws/src/robbie_ros/robbie_ai/data/robbie.pkl', 'rb') #change location
        self.MeMemory = pickle.load(pkl_file)
        pkl_file.close()
        return self.MeMemory

    def MeMemory_write(self, memory):
        output = open('~/catkin_ws/src/robbie_ros/robbie_ai/data/robbie.pkl', 'wb')
    ...
    def MeEmotion_read(self):
        ...
        '''
        pkl_file = open('~/catkin_ws/src/robbie_ros/robbie_ai/data/emotion.pkl', 'rb') #change location
    ...
    def MeEmotion_write(self, x,y):
        w = x,y
        output = open('~/catkin_ws/src/robbie_ros/robbie_ai/data/emotion.pkl', 'wb')
