...
class PhoenixControl():
    def __init__(self):
        ...
        with STAY_HEALTHY:
            ...
            CHARGE_ROBOT = ServiceTask("CHARGE_ROBOT", "battery_simulator/set_battery_level", SetBatteryLevel, 300, result_cb=self.recharge_cb)
        ...
        with GOTO:
            GOTO_LOCATION = MonitorTask("GOTO_LOCATION", "commands", String, self.goto_location)
            #TIMER1 = Timer1()
            #TIMER5 = Timer5()
