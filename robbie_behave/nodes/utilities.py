...
class Robbie_memory():
    ...
    def MeMemory_read(self):
        ...
        '''
        pkl_file = open('/home/tim/catkin_ws/src/robbie_ros/robbie_behave/nodes/robbie.pkl', 'rb') #change location
        self.MeMemory = pickle.load(pkl_file)
        pkl_file.close()
        return self.MeMemory

    def MeMemory_write(self, memory):
        output = open('/home/tim/catkin_ws/src/robbie_ros/robbie_behave/nodes/robbie.pkl', 'wb')
    ...
    def MeEmotion_read(self):
        ...
        '''
        pkl_file = open('/home/tim/catkin_ws/src/robbie_ros/robbie_behave/nodes/emotion.pkl', 'rb') #change location
    ...
    def MeEmotion_write(self, x,y):
        w = x,y
        output = open('/home/tim/catkin_ws/src/robbie_ros/robbie_behave/nodes/emotion.pkl', 'wb')
