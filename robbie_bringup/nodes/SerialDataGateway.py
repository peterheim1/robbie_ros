...
class SerialDataGateway(object):
	...
	def __init__(self, port="/dev/sensors/ftdi_A500CNMH", baudrate=57600, lineHandler = _OnLineReceived):
		'''
	...
	if __name__ == '__main__':
		dataReceiver = SerialDataGateway("/dev/sensors/ftdi_A500CNMH",  57600)
		dataReceiver.Start()
