...
DualMotorShield::DualMotorShield(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
...
void DualMotorShield::setM1Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DualMotorShield::setM2Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DualMotorShield::setBrakes(int m1Brake, int m2Brake)
{
  setM1Brake(m1Brake);
  setM2Brake(m2Brake);
}
...
unsigned int DualMotorShield::getM1CurrentMilliamps()
{
...
unsigned int DualMotorShield::getM2CurrentMilliamps()
{
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned char DualMotorShield::getM1Fault()
{
  return !digitalRead(_EN1DIAG1);
}

// Return error status for motor 2 
unsigned char DualMotorShield::getM2Fault()
{
