...
int MinVal = 100;
int MaxVal = 980;
volatile long Target;//removed 10


/* Include definition of serial commands */
#include "commands.h"

int ADC_SetPoint = 448;
...
#define P_FRACTION 1       //0.0 - 10.0 (0.3)
#define I_FRACTION 2.0         //0.0 - 10.0 (0.3)
#define D_FRACTION 5.0         //0.0 - 10.0 (4.0)
...
int runCommand() {
  ...
  case RIGHT_LIFT://c
    ...
    break;
  case LEFT_LIFT://d
    Serial.print("44");// joint message left_tilt
    Serial.print("\t");
