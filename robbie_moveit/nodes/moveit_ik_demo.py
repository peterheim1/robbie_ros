...
class MoveItDemo:
    def __init__(self):
        ...
        right_arm.set_named_target('start')
        right_arm.go()
        rospy.sleep(2)
        ...
        target_pose.pose.position.x = 0.446550517407
        target_pose.pose.position.y = 0.000930814951872
        target_pose.pose.position.z = 0.74
        target_pose.pose.orientation.x = -2.41392721268e-05
        target_pose.pose.orientation.y = -1.35514992109e-06
        target_pose.pose.orientation.z = -2.55272223138e-05
        target_pose.pose.orientation.w = 0.999999999382 
