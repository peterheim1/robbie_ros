...
class HeadTracker():
    def __init__(self):
        ...
        self.head_tilt_mod_joint = rospy.get_param('~head_tilt_joint', 'head_tilt_mod_joint')
    ...
    def set_joint_cmd(self, msg):
        ...
        try:
            ...
            # Set the target position ahead or behind the current position
            current_tilt = self.joint_state.position[self.joint_state.name.index(self.head_tilt_mod_joint)]
